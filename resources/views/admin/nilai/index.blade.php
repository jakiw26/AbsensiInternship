    ...
    <div class="flex min-h-screen">
        ...
        <aside id="sidebar"
            ...
            <div class="px-4 py-4 border-t border-white/10">
                ...
                <div class="flex items-center gap-3 px-2 py-2">
                    ...
                    <div class="w-10 h-10 rounded-full bg-gradient-to-br from-amber-400 to-yellow-600
        ...
        <div class="flex-1 md:ml-64 min-w-0">
            ...
            <header class="sticky top-0 z-20 bg-white/95 backdrop-blur border-b border-slate-200
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-xs md:text-sm text-slate-400 mt-1">Beri dan pantau penilaian seluruh peserta internship.</p>
                    </div>
                ...
                <div class="relative">
                    ...
                    <div id="profile-menu"
                        ...
                        <a href="/admin/profil" class="flex items-center gap-3 px-4 py-3 text-sm text-slate-600 hover:bg-slate-50 transition">
            ...
            <main class="p-4 md:p-8 space-y-8">
                ...
                @if (session('success'))
                    <div class="rounded-2xl bg-emerald-50 border border-emerald-200 text-emerald-700 text-sm px-5 py-3">
                        {{ session('success') }}
                    </div>
                @endif
                ...
                <section class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                    ...
                    <div class="px-5 md:px-6 py-5 border-b border-slate-100 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-400 mt-1">Klik "Beri Nilai" untuk menilai atau memperbarui nilai peserta.</p>
                        </div>
                        ...
                        <table class="w-full text-sm">
                            ...
                            <thead>
                                ...
                                <tr class="bg-[#111827]">
                                    ...
                                    <th class="rounded-tl-xl px-5 py-4 text-left text-xs font-semibold text-white uppercase tracking-wider whitespace-nowrap">
                                        Nama
                                    </th>
 
                                    <th class="px-5 py-4 text-center text-xs font-semibold text-white uppercase tracking-wider whitespace-nowrap">
                                        Kedisiplinan
                                    </th>
                                    ...
                                    <th class="rounded-tr-xl px-5 py-4 text-right text-xs font-semibold text-white uppercase tracking-wider whitespace-nowrap">
                                        Aksi
                                    </th>
                                ...
                                @forelse ($internships as $user)
                                    ...
                                    <tr class="hover:bg-slate-50/70 transition">
                                        ...
                                        <td class="px-5 py-4 text-center">
                                            <span class="inline-flex min-w-12 items-center justify-center rounded-lg bg-amber-50
                                        ...
                                        <td class="px-5 py-4 text-center">
                                            <span class="inline-flex min-w-12 items-center justify-center rounded-lg bg-blue-50
                                        ...
                                        <td class="px-5 py-4 text-center">
                                            <span class="inline-flex min-w-12 items-center justify-center rounded-lg bg-emerald-50
                                        ...
                                        <td class="px-5 py-4 text-center whitespace-nowrap">
                                            ...
                                            @if ($user->nilai)
                                                <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium bg-emerald-50 text-emerald-600">
                                                    <span class="w-1.5 h-1.5 rounded-full bg-emerald-500"></span>
                                                    Sudah Dinilai
                                                </span>
                                            @else
                                                <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium bg-amber-50 text-amber-600">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="6" class="px-5 py-16 text-center">
                                            ...
                                            <div class="flex flex-col items-center">
                                                ...
                                                <p class="text-sm font-semibold text-slate-600">Tidak ada data internship</p>
                                                <p class="text-xs text-slate-400 mt-1">Data akan muncul di sini setelah ditambahkan.</p>
            ...
            <form id="nilai-modal-form" method="POST" action="">
                ...
                <div class="space-y-4 mb-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="kedisiplinan" id="nilai-kedisiplinan" min="0" max="100" required
                    ...
                    <div>
                        ...
                        <input type="number" name="keterampilan" id="nilai-keterampilan" min="0" max="100" required
                            class="w-full px-4 py-2.5 text-sm rounded-xl border border-slate-200
                    ...
                    <div>
                        ...
                        <input type="number" name="skill" id="nilai-skill" min="0" max="100" required
                            class="w-full px-4 py-2.5 text-sm rounded-xl border border-slate-200
