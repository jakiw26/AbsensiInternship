            ...
            <main class="p-4 md:p-8 space-y-8">
                ...
                <section>
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <a href="/admin/absensi" class="hidden md:inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-900 text-white text-xs font-medium hover:bg-slate-800 transition">
                            Lihat Semua
                                        ...
                                        <tr class="hover:bg-slate-50/70 transition">
                                            <td class="px-5 py-4 whitespace-nowrap">
                                                <div class="flex items-center gap-3">
                                                    <div class="w-9 h-9 rounded-full bg-slate-100 flex items-center justify-center text-xs font-semibold text-slate-500">
                                            ...
                                            <td class="px-5 py-4 whitespace-nowrap">
                                                @if ($absensi->jam_masuk)
                                                    <span class="inline-flex items-center gap-2 font-medium text-emerald-600">
                                            ...
                                            <td class="px-5 py-4 whitespace-nowrap">
                                                ...
                                                @elseif ($absensi->status === 'izin')
                                                    <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium bg-blue-50 text-blue-600">
                                                        <span class="w-1.5 h-1.5 rounded-full bg-blue-500">
                                                        </span>
                                                        Izin
                                                    </span>
                                                @elseif ($absensi->status === 'alfa')
                                                    <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium bg-red-50 text-red-600">
