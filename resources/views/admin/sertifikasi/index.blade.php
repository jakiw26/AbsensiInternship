...
<body class="min-h-screen bg-slate-50 font-sans text-slate-800">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <h1
                                    class="font-serif text-2xl text-slate-900
                                    md:text-3xl">
                        ...
                        <table class="w-full text-sm">
                            ...
                            <thead>
                                ...
                                <tr class="bg-[#111827]">
                                    ...
                                    <th
                                        class="w-52 px-5 py-4 text-center
                                        text-xs font-semibold uppercase
                                        tracking-wider text-white">
    ...
    <div id="sertifikat-modal" class="fixed inset-0 z-50 hidden items-center justify-center
    bg-black/50 p-4">
        ...
        */
        ...
        document.querySelectorAll('[data-modal-target="sertifikat-modal"]').forEach(button => {
            ...
            button.addEventListener('click', function() {
                ...
                /*
                 * Action sementara.
                 * Sesuaikan URL ini dengan route store kamu.
                 */
