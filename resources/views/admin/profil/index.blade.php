        ...
        <div class="flex-1 md:ml-64 min-w-0">
            ...
            <main class="space-y-5 p-4 md:p-8">
                <section>
                    ...
                    <div class="rounded-2xl border border-slate-200 bg-white px-5 py-5 shadow-sm md:px-6 md:py-5">
                    ...
                    <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                        <div class="px-5 pt-6 pb-5 md:px-7 md:pb-6">
                            <div class="flex flex-col gap-4 sm:flex-row sm:items-center">
                                <div class="flex h-20 w-20 flex-shrink-0 items-center justify-center overflow-hidden rounded-2xl border border-slate-200 bg-slate-100 text-2xl font-bold text-slate-500 md:h-24 md:w-24">
                            ...
                            <div class="mt-4 flex flex-wrap items-center gap-2">
                                @if (auth()->user()->is_active)
                                    <span class="inline-flex items-center gap-2 rounded-full bg-emerald-50 px-3 py-1.5 text-xs font-medium text-emerald-600">
                                        <span class="h-1.5 w-1.5 rounded-full bg-emerald-500">
                                        </span>
                                        Akun Aktif
                                    </span>
                                @else
                                    <span class="inline-flex items-center gap-2 rounded-full bg-red-50 px-3 py-1.5 text-xs font-medium text-red-600">
                                ...
                                <span class="inline-flex items-center gap-2 rounded-full bg-slate-100 px-3 py-1.5 text-xs font-medium capitalize text-slate-500">
                    ...
                    <div class="grid gap-5 lg:grid-cols-3">
                        <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm lg:col-span-2">
                            ...
                            <div class="divide-y divide-slate-100">
                                <div class="flex flex-col gap-2 px-5 py-4 sm:flex-row sm:items-center sm:justify-between md:px-6">
                                    <div class="flex items-center gap-3">
                                ...
                                <div class="flex flex-col gap-2 px-5 py-4 sm:flex-row sm:items-start sm:justify-between md:px-6">
                                    <div class="flex items-center gap-3">
                                        <div class="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-lg bg-slate-100">
                                            <svg class="h-4 w-4 text-slate-500" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                    ...
                                    <span class="text-sm font-semibold leading-6 text-slate-800 sm:max-w-md sm:text-right">
                            ...
                            <div class="space-y-5 p-5">
                                <div>
                                    ...
                                    <div class="mt-2">
                                        ...
                                        @else
                                            <span class="inline-flex items-center gap-2 rounded-full bg-red-50 px-3 py-1.5 text-xs font-semibold text-red-600">
                                                <span
                                                    class="h-1.5 w-1.5 rounded-full
                                                    bg-red-500">
                                                </span>
