...
<body class="min-h-screen bg-slate-50 font-sans text-slate-800">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="min-w-0 flex-1 md:ml-64">
            <header
                class="sticky top-0 z-20 flex items-center justify-between border-b border-slate-200 bg-white/95 px-4 py-4 backdrop-blur md:px-8">
                <div class="flex items-center gap-4">
                    <button id="btn-toggle-sidebar" type="button"
                        class="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-100 text-slate-700 transition hover:bg-slate-200 md:hidden">
                    ...
                    <div>
                        ...
                        <h2 class="mt-0.5 font-serif text-xl text-slate-900 md:text-2xl">
                            Laporan 
                        </h2>
                ...
                <div class="relative">
                    <button type="button" id="profile-menu-button"
                        class="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-amber-400 to-yellow-600 text-sm font-semibold text-white shadow-sm transition hover:scale-105">
                        {{ strtoupper(substr(auth()->user()->name ?? 'A', 0, 1)) }}
                    </button>

                    <div id="profile-menu"
                        class="absolute right-0 z-50 mt-3 hidden w-60 overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-xl shadow-slate-200/70">
            ...
            <main class="space-y-6 p-4 md:p-8">
                ...
                <section>
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                            ...
                            <p class="mt-2 text-3xl font-boldtext-red-500">
                                {{ $jumlahAlfa ?? 0 }}
                            </p>
                ...
                <section>
                    ...
                    <div class="grid gap-4 md:grid-cols-3">
                        ...
                        <a href="/admin/internship" class="group rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
                        ...
                        <a href="/admin/absensi" class="group rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
                            <div class="mb-4 flex h-10 w-10 items-center justify-center rounded-xl bg-amber-50">
                                <svg class="h-5 w-5 text-amber-500" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <circle cx="12" cy="12" r="8" stroke="currentColor"
                                        stroke-width="1.5" />
                        ...
                        <a href="/admin/nilai" class="group rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
                            <div class="mb-4 flex h-10 w-10 items-center justify-center rounded-xl bg-emerald-50">
                                <svg class="h-5 w-5 text-emerald-500" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
