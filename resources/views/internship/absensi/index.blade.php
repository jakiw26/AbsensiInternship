...
<head>
    ...
    <title>Absensi - Internship Panel</title>
        ...
        <aside id="sidebar"
            ...
            <nav class="flex-1 px-4 py-6 space-y-1.5">
                ...
                <a href="/internship/dashboard"
                    ...
                    ? 'bg-white text-[#111827] font-semibold shadow-sm': 'text-white/55 hover:bg-white/5 hover:text-white' }}">
                    <svg class="w-5 h-5 flex-shrink-0" viewBox="0 0 20 20" fill="none">
                        <path d="M3 10.5 10 4l7 6.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"stroke-linejoin="round" />
                ...
                <a href="/internship/nilai"
                    ...
                    <svg class="w-5 h-5 flex-shrink-0" viewBox="0 0 20 20" fill="none">
                        <path d="M6 3h8l2 2v12H4V5l2-2Z" stroke="currentColor" stroke-width="1.5"stroke-linejoin="round" />
